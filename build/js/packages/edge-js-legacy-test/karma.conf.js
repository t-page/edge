...
config.set({
  "singleRun": true,
  "autoWatch": false,
  "basePath": "/Users/tompage/edge/edge/build/js/packages/edge-js-legacy-test/node_modules",
  "files": [
    "/Users/tompage/edge/edge/build/js/packages/edge-js-legacy-test/adapter-browser.js"
  ],
  "frameworks": [
    "mocha"
  ],
  "client": {
    "args": [
      "--include",
      "effects.OptionTest.testCreateSome"
    ]
  },
  "browsers": [
    "ChromeHeadless"
...
;(function(config) {
    ...
    const handler = (percentage, message, ...args) => {
        ...
        msg = msg.replace(new RegExp("/Users/tompage/edge/edge/build/js", 'g'), '');;
        console.log(msg);
    };
